 ...
 *  @version 1.2
 *    Date: Mon Jan 23 07:24:47 EST 2012
 */
...
public class KDivergenceMeasure implements Measure
{
	private MathOps ops = new MathOps();
		...
		public SimilarityNumber compare(RGBHistogramDescriptor feature1, RGBHistogramDescriptor feature2) throws Exception 
		{
					...
					double measurement  = ops.d_k_divergence( normHist1, normHist2 );
