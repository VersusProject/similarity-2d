 ...
 *  @version 1.2
 *    Date: Mon Jan 23 07:24:28 EST 2012
 */
...
public class CityBlockL1Measure implements Measure
{
	private MathOps ops = new MathOps();
		...
		public SimilarityNumber compare(RGBHistogramDescriptor feature1, RGBHistogramDescriptor feature2) throws Exception 
		{
					...
					double measurement  = ops.d_city_block( normHist1, normHist2 );
