 ...
 *  @version 1.2
 *    Date: Mon Jan 23 07:24:39 EST 2012
 */
...
public class BhattacharyyaMeasure implements Measure
{
	private MathOps ops = new MathOps();
		...
		public SimilarityNumber compare(RGBHistogramDescriptor feature1, RGBHistogramDescriptor feature2) throws Exception 
		{
					...
					double measurement  = ops.d_bhattacharyya( normHist1, normHist2 );
