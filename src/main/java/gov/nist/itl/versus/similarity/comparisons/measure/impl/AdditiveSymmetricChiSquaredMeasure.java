...
public class AdditiveSymmetricChiSquaredMeasure implements Measure
{
	private MathOps ops = new MathOps();
		...
		public SimilarityNumber compare(RGBHistogramDescriptor feature1, RGBHistogramDescriptor feature2) throws Exception 
		{
					...
					double measurement  = ops.d_additive_symmetric_chiSquared( normHist1, normHist2 );
		...
		public String getName() {
			return "AdditiveSymmetricChiSquaredMeasure";
		}
