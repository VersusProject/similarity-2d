...
public class DicePixelMeasure implements LabeledMeasure, HasCategory, HasHelp
{
			...
			throws Exception 
	{
		...
		Double measurement = mops.pixel_measure_dice(im1, im2 );	
			if ( measurement == null ) 
	...
	public String getName() {
		return "Dice Pixel Measure";
	}

	@Override
	public Class getType() {
		return DicePixelMeasure.class;
	}	
	...
	public InputStream getHelpZipped() {
		return HelpProvider.getHelpZipped(DicePixelMeasure.class);
	}

	@Override
	public String getHelpSHA1() {
		return HelpProvider.getHelpSHA1(DicePixelMeasure.class);
	}
}