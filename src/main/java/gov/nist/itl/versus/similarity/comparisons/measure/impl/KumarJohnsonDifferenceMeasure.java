 ...
 *  @version 1.2
 *    Date: Mon Jan 23 07:24:50 EST 2012
 */
...
public class KumarJohnsonDifferenceMeasure implements Measure
{
	private MathOps ops = new MathOps();
		...
		public SimilarityNumber compare(RGBHistogramDescriptor feature1, RGBHistogramDescriptor feature2) throws Exception 
		{
					...
					double measurement  = ops.d_kumar_johnson_difference( normHist1, normHist2 );
		...
		public String getName() {
			return "KumarJohnsonDifferenceMeasure";
		}
