 ...
 *  @version 1.2
 *    Date: Mon Jan 23 07:24:37 EST 2012
 */
...
public class KumarHassebrookPCEMeasure implements Measure
{
	private MathOps ops = new MathOps();
		...
		public SimilarityNumber compare(RGBHistogramDescriptor feature1, RGBHistogramDescriptor feature2) throws Exception 
		{
					...
					double measurement  = ops.d_kumar_hassebrook_pce( normHist1, normHist2 );
		...
		public String getName() {
			return "KumarHassebrookPCEMeasure";
		}
