...
public class AdjustedRandIndexMeasure implements LabeledMeasure
{
	@Override
			...
			throws Exception 
	{
		...
		double ari = mops.d_ari(im1, im2 );		
		return new SimilarityNumber(ari);
	}
	...
	public String getName() {
		return "AdjustedRandIndexMeasure";
	}
