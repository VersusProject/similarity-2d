 ...
 *  @version 1.2
 *    Date: Mon Jan 23 07:24:48 EST 2012
 */
...
public class JensenShannonMeasure implements Measure
{
	private MathOps ops = new MathOps();
		...
		public SimilarityNumber compare(RGBHistogramDescriptor feature1, RGBHistogramDescriptor feature2) throws Exception 
		{
					...
					double measurement  = ops.d_jensen_shannon( normHist1, normHist2 );
