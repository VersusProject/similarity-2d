 ...
 *  @version 1.2
 *    Date: Mon Jan 23 07:24:32 EST 2012
 */
...
public class CzekanowskiMeasure implements Measure, HasCategory {
    ...
    public SimilarityNumber compare(RGBHistogramDescriptor feature1, RGBHistogramDescriptor feature2) throws Exception {
        ...
        double measurement = ops.d_czekanowski1(normHist1, normHist2);
