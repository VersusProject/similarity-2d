 ...
 *  @version 1.2
 *    Date: Mon Jan 23 07:24:43 EST 2012
 */
...
public class ProbabilisticSymmetricChiSquaredMeasure implements Measure
{
	private MathOps ops = new MathOps();
		...
		public SimilarityNumber compare(RGBHistogramDescriptor feature1, RGBHistogramDescriptor feature2) throws Exception 
		{
					...
					double measurement  = ops.d_probabilistic_symmetric_chiSquared( normHist1, normHist2 );
		...
		public String getName() {
			return "ProbSymChiSquaredMeasure";
		}
