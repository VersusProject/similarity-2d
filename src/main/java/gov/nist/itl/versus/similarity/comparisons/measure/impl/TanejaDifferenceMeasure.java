 ...
 *  @version 1.2
 *    Date: Mon Jan 23 07:24:49 EST 2012
 */
...
public class TanejaDifferenceMeasure implements Measure
{
	private MathOps ops = new MathOps();
		...
		public SimilarityNumber compare(RGBHistogramDescriptor feature1, RGBHistogramDescriptor feature2) throws Exception 
		{
					...
					double measurement  = ops.d_taneja_difference( normHist1, normHist2 );
		...
		public String getName() {
			return "TanejaDifferenceMeasure";
		}
