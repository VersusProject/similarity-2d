...
public class MathOpsE {
	...
	/*
	 * metric family: Minkowski Family Metric name: Euclidean_L2
	 * 
	 * @see <a href=
	 * "http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf"
	 * >
	 * http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf
	 * </a>
	 * 
	 * description: Assumes 2 probability distribution functions (1D vector
	 * PDFs) as input and generates a single numerical output. Is called by
	 * appropriate related class in
	 * gov.nist.itl.versus.similarity.comparisons.measure.impl.* .
	 * 
	 * 
	 * @author B. Long version: 1.0
	 */

	// eqn #1
	public Double histogram_measure_euclidean(Double[] P, Double[] Q)
			throws Exception {
	...
	/*
	 * metric family: Minkowski Family Metric name: City block L1
	 * 
	 * @see <a href=
	 * "http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf"
	 * >
	...
	// eqn #2
	public Double histogram_measure_city_block(Double[] P, Double[] Q)
			throws Exception {
	...
	/*
	 * metric family: Minkowski Family Metric name: Minkowski_LP
	 * 
	 * @see <a href=
	 * "http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf"
	 * >
	...
	// eqn #3
	public Double histogram_measure_minkowski(Double[] P, Double[] Q)
			throws Exception {
	...
	/*
	 * metric family: Minkowski Family Metric name: Chebyshev L_INF
	 * 
	 * @see <a href=
	 * "http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf"
	 * >
	...
	// eqn #4
	public Double histogram_measure_chebyshev(Double[] P, Double[] Q)
			throws Exception {
	...
	/*
	 * metric family: L1 Family Metric name: Sorensen
	 * 
	 * @see <a href=
	 * "http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf"
	 * >
	...
	// eqn #5
	public Double histogram_measure_sorensen(Double[] P, Double[] Q)
			throws Exception {
	...
	/*
	 * metric family: L1 Family Metric name: Gower
	 * 
	 * @see <a href=
	 * "http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf"
	 * >
	...
	// eqn #7
	public Double histogram_measure_gower(Double[] P, Double[] Q)
			throws Exception {
	...
	// eqn #6
	public Double histogram_measure_gower2(Double[] P, Double[] Q, Double[] R)
			throws Exception {
	...
	/*
	 * metric family: L1 Family Metric name: Soergel
	 * 
	 * @see <a href=
	 * "http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf"
	 * >
	...
	// eqn #8
	public Double histogram_measure_soergel(Double[] P, Double[] Q)
			throws Exception {
	...
	/*
	 * metric family: L1 Family Metric name: Kulczynski d
	 * 
	 * @see <a href=
	 * "http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf"
	 * >
	...
	// eqn #9
	public Double histogram_measure_kulczynski(Double[] P, Double[] Q)
			throws Exception {
	...
	/*
	 * metric family: L1 Family Metric name: Canberra
	 * 
	 * @see <a href=
	 * "http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf"
	 * >
	...
	// eqn #10
	public Double histogram_measure_canberra(Double[] P, Double[] Q)
			throws Exception {
	...
	/*
	 * metric family: L1 Family Metric name: Lorentzian
	 * 
	 * @see <a href=
	 * "http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf"
	 * >
	...
	// eqn #11
	public Double histogram_measure_lorentzian(Double[] P, Double[] Q)
			throws Exception {
	...
	/*
	 * metric family: Intersection Family Metric name: Intersection
	 * 
	 * @see <a href=
	 * "http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf"
	 * >
	...
	// eqn #12
	public Double histogram_measure_intersection_IS(Double[] P, Double[] Q)
			throws Exception {
		chkargs("histogram_measure_intersection_IS", P, Q);
		Double[] D1 = min(P, Q);
		Double d2 = sum(D1);
		// check if the value is larger than 1
		if( d2.compareTo( new Double(1.0)) > 0  ){
			d2 = new Double(1.0);
		}
	...
	// eqn #13.1
	public Double histogram_measure_intersection_dNonIS(Double[] P, Double[] Q)
			throws Exception {
		...
		if (d1 > 1 && Math.abs(sum(P) - 1) < MathOpsE.EPSILON
				&& Math.abs(sum(Q) - 1) < MathOpsE.EPSILON) {
			return 0.0;
		}
	...
	// eqn #13.2
	public Double histogram_measure_intersection_dNonIS2(Double[] P, Double[] Q)
			throws Exception {
	...
	/*
	 * metric family: Intersection Family Metric name: Wave Hedges
	 * 
	 * @see <a href=
	 * "http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf"
	 * >
	...
	// eqn #15
	public Double histogram_measure_wave_hedges(Double[] P, Double[] Q)
			throws Exception {
	...
	// eqn #14
	public Double histogram_measure_wave_hedges_dWH(Double[] P, Double[] Q)
			throws Exception {
	...
	/*
	 * metric family: Intersection Family Metric name: Czekanowski s
	 * 
	 * @see <a href=
	 * "http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf"
	 * >
	...
	// eqn #16
	public Double histogram_measure_czekanowski(Double[] P, Double[] Q)
			throws Exception {
	...
	// eqn #17.1
	public Double histogram_measure_czekanowski_dCze(Double[] P, Double[] Q)
			throws Exception {
	...
	// eqn #17.2
	public Double histogram_measure_czekanowski_dCze2(Double[] P, Double[] Q)
			throws Exception {
	...
	/*
	 * metric family: Intersection Family Metric name: Motyka
	 * 
	 * @see <a href=
	 * "http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf"
	 * >
	...
	// eqn #18
	public Double histogram_measure_motyka(Double[] P, Double[] Q)
			throws Exception {
	...
	// eqn #19.1
	public Double histogram_measure_motyka_dMot(Double[] P, Double[] Q)
			throws Exception {
	...
	// eqn #19.2
	public Double histogram_measure_motyka_dMot2(Double[] P, Double[] Q)
			throws Exception {
	...
	/*
	 * metric family: Intersection Family Metric name: Kulczynski s
	 * 
	 * @see <a href=
	 * "http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf"
	 * >
	...
	// eqn #20.1
	public Double histogram_measure_kulczynski_s(Double[] P, Double[] Q)
			throws Exception {
	...
	// eqn #20.2
	public Double histogram_measure_kulczynski_s2(Double[] P, Double[] Q)
			throws Exception {
	...
	/*
	 * metric family: Intersection Family Metric name: Ruzicka
	 * 
	 * @see <a href=
	 * "http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf"
	 * >
	...
	public Double histogram_measure_ruzicka(Double[] P, Double[] Q)
			throws Exception {
	...
	/*
	 * metric family: Intersection Family Metric name: Tanimoto
	 * 
	 * @see <a href=
	 * "http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf"
	 * >
	...
	// eqn #23
	public Double histogram_measure_tanimoto(Double[] P, Double[] Q)
			throws Exception {
	...
	// eqn #22
	public Double histogram_measure_tanimoto2(Double[] P, Double[] Q)
			throws Exception {
	...
	/*
	 * metric family: Inner Product Family Metric name: Inner Product
	 * 
	 * @see <a href=
	 * "http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf"
	 * >
	...
	// eqn #24
	public Double histogram_measure_inner_product(Double[] P, Double[] Q)
			throws Exception {
	...
	/*
	 * metric family: Inner Product Family Metric name: Harmonic Mean
	 * 
	 * @see <a href=
	 * "http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf"
	 * >
	...
	// eqn #25
	public Double histogram_measure_harmonic_mean(Double[] P, Double[] Q)
			throws Exception {
		...
		// check if the value is larger than 1
		if( d5.compareTo( new Double(1.0)) > 0  ){
			d5 = new Double(1.0);
		}
	...
	/*
	 * metric family: Inner Product Family Metric name: Cosine
	 * 
	 * @see <a href=
	 * "http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf"
	 * >
	...
	// eqn #26
	public Double histogram_measure_cosine(Double[] P, Double[] Q)
			throws Exception {
	...
	/*
	 * metric family: Inner Product Family Metric name: Kumar-Hassebrook (PCE)
	 * 
	 * @see <a href=
	 * "http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf"
	 * >
	...
	// eqn #27
	public Double histogram_measure_kumar_hassebrook_pce(Double[] P, Double[] Q)
			throws Exception {
		chkargs("histogram_measure_kumar_hassebrook_pce", P, Q);

		// NOTE: The implementation of this measure has been commented out and
		// replaced with a constant NaN result
		// due to the fact that the source paper
		// (http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf)
		// from which this was derived copied and pasted the formula for Jaccard
		// in the description for Kumar-Hassebrook-PCE.
		// Thus, when a replacement formula is identified, the implementation
		// will be updated accordingly.

		/*
		 * // bottom right-most term Double[] D1 = mult(P,Q); Double d2 =
		 * sum(D1);
		 * 
		 * // bottom middle term Double[] D3 = square(Q); Double d4 = sum(D3);
		 * 
		 * // bottom left term Double[] D5 = square(P); Double d6 = sum(D5); //
		 * combine left and middle Double d7 = add(d6,d4);
		 * 
		 * // bottom: combine Double d8 = sub(d7, d2);
		 * 
		 * // top Double[] D9 = mult(P,Q); Double d10 = sum(D9);
		 * 
		 * // combine Double d11 = div(d10, d8);
		 */
	...
	/*
	 * metric family: Inner Product Family Metric name: Jaccard
	 * 
	 * @see <a href=
	 * "http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf"
	 * >
	...
	// eqn #28
	public Double histogram_measure_jaccard(Double[] P, Double[] Q)
			throws Exception {
	...
	public Double histogram_measure_jaccard_dJac1(Double[] P, Double[] Q)
			throws Exception {
	...
	public Double histogram_measure_jaccard_dJac2(Double[] P, Double[] Q)
			throws Exception {
	...
	/*
	 * metric family: Inner Product Family Metric name: Dice
	 * 
	 * @see <a href=
	 * "http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf"
	 * >
	...
	public Double histogram_measure_dice(Double[] P, Double[] Q)
			throws Exception {
	...
	// eqn #31.1
	public Double histogram_measure_dice_dDice1(Double[] P, Double[] Q)
			throws Exception {
	...
	// eqn #31.2
	public Double histogram_measure_dice_dDice2(Double[] P, Double[] Q)
			throws Exception {
	...
	/*
	 * metric family: Fidelity/Chi-Squared Family Metric name: Fidelity
	 * 
	 * @see <a href=
	 * "http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf"
	 * >
	...
	// eqn #32
	public Double histogram_measure_fidelity(Double[] P, Double[] Q)
			throws Exception {
		...
		Double d3 = sum(D2);
		// check if the value is larger than 1
		if( d3.compareTo( new Double(1.0)) > 0  ){
			d3 = new Double(1.0);
		}
	...
	/*
	 * metric family: Fidelity/Chi-Squared Family Metric name: Bhattacharyya
	 * 
	 * @see <a href=
	 * "http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf"
	 * >
	...
	// eqn #33
	public Double histogram_measure_bhattacharyya(Double[] P, Double[] Q)
			throws Exception {
		...
		Double d3 = sum(D2);
		// Case of normalized histograms
		if (d3 > 1 && Math.abs(sum(P) - 1) < MathOpsE.EPSILON
				&& Math.abs(sum(Q) - 1) < MathOpsE.EPSILON) {
			return 0.0;
		}
		Double d4 = ln(d3);
	...
	/*
	 * metric family: Fidelity/Chi-Squared Family Metric name: Hellinger
	 * 
	 * @see <a href=
	 * "http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf"
	 * >
	...
	// eqn #35
	public Double histogram_measure_hellinger(Double[] P, Double[] Q)
			throws Exception {
	...
	// eqn #34
	public Double histogram_measure_hellinger_dH2(Double[] P, Double[] Q)
			throws Exception {
	...
	/*
	 * metric family: Fidelity/Chi-Squared Family Metric name: Matusita
	 * 
	 * @see <a href=
	 * "http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf"
	 * >
	...
	// eqn #37
	public Double histogram_measure_matusita(Double[] P, Double[] Q)
			throws Exception {
	...
	// eqn #36
	public Double histogram_measure_matusita_dM2(Double[] P, Double[] Q)
			throws Exception {
	...
	/*
	 * metric family: Fidelity/Chi-Squared Family Metric name: Squared-chord
	 * 
	 * @see <a href=
	 * "http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf"
	 * >
	...
	// eqn #38
	public Double histogram_measure_squared_chord(Double[] P, Double[] Q)
			throws Exception {
	...
	// eqn #39.1
	public Double histogram_measure_squared_chord_Ssqc1(Double[] P, Double[] Q)
			throws Exception {
		...
		/*
		 * if (d1 > 1 && Math.abs(sum(P) - 1) < MathOpsE.EPSILON &&
		 * Math.abs(sum(Q) - 1) < MathOpsE.EPSILON) { return 0.0; }
		 */Double d2 = sub(1.0d, d1);
	...
	// eqn #39.2
	public Double histogram_measure_squared_chord_Ssqc2(Double[] P, Double[] Q)
			throws Exception {
	...
	/*
	 * metric family: Squared_L2/Chi-Squared Family Metric name: Squared
	 * Euclidean
	 * 
	 * @see <a href=
	 * "http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf"
	...
	// eqn #40
	public Double histogram_measure_squared_euclidean(Double[] P, Double[] Q)
			throws Exception {
	...
	/*
	 * metric family: Squared_L2/Chi-Squared Family Metric name: Pearson
	 * Chi-Squared
	 * 
	 * @see <a href=
	 * "http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf"
	...
	// eqn #41
	public Double histogram_measure_pearson_chiSquared(Double[] P, Double[] Q)
			throws Exception {
	...
	/*
	 * metric family: Squared_L2/Chi-Squared Family Metric name: Neyman
	 * Chi-Squared
	 * 
	 * @see <a href=
	 * "http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf"
	...
	// eqn #42
	public Double histogram_measure_neyman_chiSquared(Double[] P, Double[] Q)
			throws Exception {
	...
	// eqn #43
	public Double histogram_measure_squared_chiSquared(Double[] P, Double[] Q)
			throws Exception {
	...
	/*
	 * metric family: Squared_L2/Chi-Squared Family Metric name: Probabilistic
	...
	// eqn #44
	public Double histogram_measure_probabilistic_symmetric_chiSquared(
			Double[] P, Double[] Q) throws Exception {
	...
	/*
	 * metric family: Squared_L2/Chi-Squared Family Metric name: Divergence
	 * 
	 * @see <a href=
	 * "http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf"
	 * >
	...
	// eqn #45
	public Double histogram_measure_divergence(Double[] P, Double[] Q)
			throws Exception {
	...
	/*
	 * metric family: Squared_L2/Chi-Squared Family Metric name: Clark
	 * 
	 * @see <a href=
	 * "http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf"
	 * >
	...
	// eqn #46
	public Double histogram_measure_clark(Double[] P, Double[] Q)
			throws Exception {
	...
	/*
	 * metric family: Squared_L2/Chi-Squared Family Metric name: Additive
	 * Symmetric Chi-Squared
	 * 
	 * @see <a href=
	 * "http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf"
	...
	// eqn #47
	public Double histogram_measure_additive_symmetric_chiSquared(Double[] P,
	...
	/*
	 * metric family: Shannon's Entropy Family Metric name: Kullback-Liebler
	 * 
	 * @see <a href=
	 * "http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf"
	 * >
	...
	// eqn #48
	public Double histogram_measure_kullback_leibler(Double[] P, Double[] Q)
			throws Exception {
	...
	/*
	 * metric family: Shannon's Entropy Family Metric name: Jeffreys
	 * 
	 * @see <a href=
	 * "http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf"
	 * >
	...
	// eqn #49
	public Double histogram_measure_jeffreys(Double[] P, Double[] Q)
			throws Exception {
	...
	/*
	 * metric family: Shannon's Entropy Family Metric name: K divergence
	 * 
	 * @see <a href=
	 * "http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf"
	 * >
	...
	// eqn #50
	public Double histogram_measure_k_divergence(Double[] P, Double[] Q)
			throws Exception {
	...
	/*
	 * metric family: Shannon's Entropy Family Metric name: Topsoe
	 * 
	 * @see <a href=
	 * "http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf"
	 * >
	...
	// eqn #51
	public Double histogram_measure_topsoe(Double[] P, Double[] Q)
			throws Exception {
	...
	/*
	 * metric family: Shannon's Entropy Family Metric name: Jensen-Shannon
	 * 
	 * @see <a href=
	 * "http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf"
	 * >
	...
	// eqn #52
	public Double histogram_measure_jensen_shannon(Double[] P, Double[] Q)
			throws Exception {
	...
	/*
	 * metric family: Shannon's Entropy Family Metric name: Jensen difference
	 * 
	 * @see <a href=
	 * "http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf"
	 * >
	...
	// eqn #53
	public Double histogram_measure_jensen_difference(Double[] P, Double[] Q)
			throws Exception {
	...
	/*
	 * metric family: Combinations Family Metric name: Taneja difference
	 * 
	 * @see <a href=
	 * "http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf"
	 * >
	...
	// eqn #54
	public Double histogram_measure_taneja_difference(Double[] P, Double[] Q)
			throws Exception {
	...
	/*
	 * metric family: Combinations Family Metric name: Kumar-Johnson
	 * 
	 * @see <a href=
	 * "http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf"
	 * >
	...
	// eqn #55
	public Double histogram_measure_kumar_johnson_difference(Double[] P,
			Double[] Q) throws Exception {
	...
	/*
	 * metric family: Combinations Family Metric name: Avg(L_1, L_INF)
	 * 
	 * @see <a href=
	 * "http://www.wseas.us/e-library/conferences/2008/harvard/math/49-577-887.pdf"
	 * >
	...
	// eqn #56
	public Double histogram_measure_avg_difference(Double[] P, Double[] Q)
			throws Exception {
	 ...
	 * @see TBD.
	 * 
	 * description: Takes 2 representations of image pixel data as input and
	 * generates a single numerical output. Is called by appropriate related
	 * class in gov.nist.itl.versus.similarity.comparisons.measure.impl.* .
	 * 
	 * @author B. Long version: 1.0
	 */

	public Double pixel_measure_ari(ImageData img1, ImageData img2)
			throws Exception {

		chkargs("pixel_measure_ari", img1, img2);
		ImageData op = new ImageData();

		Double[] im1 = img2ArrayColumnMajor(img1); // NOTE: Column-major matrix
													// traversal mimics Matlab
													// traversal pattern.
		Double[] im2 = img2ArrayColumnMajor(img2);

		// We've assumed that images are identical in size at the application
		// level.
		// Ergo,
		int imgSize = im1.length;

		Double[] im1PVS = uniqueValues(im1); // unique pixelValueSpace for each
												// image, respectively
		Double[] im2PVS = uniqueValues(im2);
		int im1LargestPV = im1PVS[im1PVS.length - 1].intValue(); // get largest
																	// pixelValue
																	// from each
																	// pixelValueSpace
		int im2LargestPV = im2PVS[im2PVS.length - 1].intValue();

		if (im1LargestPV < 1 || im2LargestPV < 1) {
			System.err.println("Error: largest pixel value from each pixel value space is less than 1, attempts to create negative sized array.");
			throw new NegativeArraySizeException();
		}
		
		Double[][] commonPixels = new Double[im1LargestPV + 1][im2LargestPV + 1]; // for
																					// counting
																					// total
																					// pixel
																					// overlaps
																					...
																					// two
																					// images
		// NOTE: We add 1 to each pixelValue dimension b/c when a given
		// pixelValue, like 255, is indexed, it goes to
		// index-location 255, which works if we allocated 256 pixelLocations in
		// which to index/count.
		...
		// capture the occurrence of the labels at the same location in each
		// image
		for (int i = 0; i < imgSize; i++) {
			im1Idx = im1[i].intValue(); // get pixel index values into the
										// commonPixels
										// pixelValueCoordinateSpace
			im2Idx = im2[i].intValue();
			commonPixels[im1Idx][im2Idx]++; // increment relative pixel
											// values
											// at (im1Px, im2Px) location
		}
		...
		// Double ARI = ( Nij - ((A2*B2)/N2) ) / ( (0.5 * (A2+B2)) -
		// ((A2*B2)/N2) );
		Double d1 = div((A2 * B2), N2);
		Double numerator = (Nij - d1);
		Double denom = ((0.5 * (A2 + B2)) - d1);

		// TODO - check if this is correct
		//http://www.otlet-institute.org/wikics/Clustering_Problems.html#toc-Subsection-4.1
			
		if (numerator.equals(0.d) && denom.equals(0.d)) {
			return 1.0; // takes care of single color images
		}
		Double ARI = div(numerator, denom);
		// Double RI = 1 + (((2*Nij) - A2 - B2) / N2) ;

		if (ARI <= Double.MIN_VALUE)
			return 0.0; // takes care of small negative values
	...
	public Double[] img2ArrayColumnMajor(ImageData im) throws Exception {
		...
		// System.out.println("(row,col,band,total)=("+row_len+","+col_len+","+band_len+","+"total="
		// + (row_len*col_len*band_len));
		// Double[][][] B = new Double[row_len][col_len][band_len];
		Double[] C = new Double[row_len * col_len * band_len];
		int index = 0;
		for (int i = 0; i < col_len; i++) { // to mirror the Matlab reference
											// implementation, walk columns
											// first, then rows
		...
		chkresult("img2ArrayColumnMajor", C);
		return C;
	}
	...
	public Double pixel_measure_ri(ImageData img1, ImageData img2)
			throws Exception {
	...
	public Double pixel_measure_dice(ImageData img1, ImageData img2)
			throws Exception {
		...
		im1 = pvrel_greaterThan(im1, 0.0d); // transform all input images to
											// binary via pixel-value-relation:
											// pixelValue>0
		im2 = pvrel_greaterThan(im2, 0.0d);

		Double[] I = add(im1, im2); // add their values together, creating a
									// composite image of their corresponding
									// values
		Double[] overlap = pvrel_equalTo(I, 2.0d); // transform combined image
													// into binary via
													// pixel-value-relation;
													// pixelValue==2 (i.e.,
													// where images had
													// pixelValue==1)\
		...
		if ((int) (sum_I.doubleValue()) == 0) {
			// this is the special case when all pixels are zero and the
			// background/foreground separation does not apply.
			// img1 and img2 have the same dimensions
			return new Double(1.0);
		}
		// use this information to compute dice
		Double dice = div(mult(2.0d, sum_overlap), add(sum_I, sum_overlap));
	...
	public Double pixel_measure_jaccard(ImageData img1, ImageData img2)
			throws Exception {

		chkargs("pixel_measure_jaccard", img1, img2);
	...
	public Double pixel_measure_tee(ImageData img1, ImageData img2)
			throws Exception {
		...
		chkresult("pixel_measure_tee", tee);
	...
	public Double pixel_measure_tet(ImageData img1, ImageData img2)
			throws Exception {
		...
		chkresult("pixel_measure_tet", tet);
	...
	public Double sum(Double[] a) throws Exception {
		...
		for (int i = 0; i < len; i++) {
			...
			if (a[i] >= Double.MAX_VALUE) // DN/PNB updates to deal with data
											// that could overflow computationn
				return Double.MAX_VALUE;
			b = add(a[i], b);
		}
		chkresult("sum", b);
	...
	public Double div(Double a, Double b) throws Exception {
		...
		// Per guidance from the survey paper, if we receive 0/0, return 0. If
		// x/0, a small value.
		if (Math.abs(a) <= Double.MIN_VALUE && Math.abs(b) <= Double.MIN_VALUE) { // 0/0
			return 0d;
		} else if (Math.abs(a) > Double.MIN_VALUE
				&& Math.abs(b) <= Double.MIN_VALUE) { // x/0
			return Double.MAX_VALUE; // dealing with divisions of/near zero =>
										// mathematically yield INFINITY. =>
										// DN/PNB updated for MAX instead.
		}
	...
	// DN/PNB - introduce method for case: (a log b) => also checks-for/handles
	// case: (0 log 0)
	public Double a_Ln_b(Double a1, Double a2) throws Exception {
		if (Math.abs(a1) <= Double.MIN_VALUE
				&& Math.abs(a2) <= Double.MIN_VALUE)
			return 0.0;
		if (a1 > Double.MIN_VALUE && Math.abs(a2) <= Double.MIN_VALUE)
			return (-Double.MAX_VALUE);
		if (-a1 > Double.MIN_VALUE && Math.abs(a2) <= Double.MIN_VALUE)
			return Double.MAX_VALUE;
	...
	// NOTE2: When/if DO need to use these, can use them for any root: sqrt,
	// cubed-root (cbrt), etc.

	/*
	 * public Double root(Double a, b) throws Exception { chkargs("root",a);
	 * chkargs("root",b); Double c = pow(a, reciprocal1(b));
	 * chkresult("root",c); return c; }
	 * 
	 * public Double[] root(Double[] a, Double[] b) throws Exception {
	 * chkargs("root",a); chkargs("root",b); int len = a.length; Double[] c =
	 * new Double[len]; for (int i=0; i < len; i++) c[i] = root(a[i], b[i]);
	 * chkresult("root",c); return c; }
	 */
	...
	/*
	 * Support method for metric implementations description: creates an array
	 * of a specific size, all having the same value (used in calculations).
	 * 
	 * @author B. Long version: 1.0
	 */
	...
	/*
	 * Support method for metric implementations description: Converts the
	 * content of an RGB histogram to the form used by the metric algorithms.
	 * 
	 * @author B. Long version: 1.0
	 */

	public Double[] rgbHistogram2Double(final RGBHistogramDescriptor d)
			throws Exception {
	...
	/*
	 * Support method for metric implementations description: Converts the
	 * content of a gray-scale histogram to the form used by the metric
	 * algorithms.
	 * 
	 * @author B. Long version: 1.0
	 */

	public Double[] grayScaleHistogram2Double(
			final GrayscaleHistogramDescriptor d) throws Exception {
...
public Double[] pixelHistogram2Double(final PixelHistogramDescriptor d) throws Exception { 
    	  ...
    	  chkresult("pixelHistogram2Double",r);
	      return r;
} 
	

	/*
	 * Support method for metric implementations description: Normalizes a raw
	 * histogram to relative frequencies. (Where the histogram was received from
	 * an RGB or gray-scale histogram feature.)
	 * 
	 * @author B. Long version: 1.0
	 */
	...
	/*
	 * Support method for metric implementations description: Normalizes an RGB
	 * histogram to relative frequencies.
	 * 
	 * @author B. Long version: 1.0
	 */

	public Double[] normalizeRgbHistogram(final RGBHistogramDescriptor d)
			throws Exception {
	...
	/*
	 * Support method for metric implementations description: Normalizes a
	 * gray-scale histogram to relative frequencies.
	 * 
	 * @author B. Long version: 1.0
	 */

	public Double[] normalizeGrayscaleHistogram(
			final GrayscaleHistogramDescriptor d) throws Exception {
	 ...
	 */		      	 
	  ...
	  public Double[] normalizePixelHistogram(final PixelHistogramDescriptor d) throws Exception { 
		  
	    	// chkargs("normalizePixelHistogram",d);
	        Double[] h = pixelHistogram2Double(d);
	        h = normalizeHistogram(h);
	        chkresult("normalizePixelHistogram",h);
	        return h;         
	  } 
	...
	public boolean chkargs(String methodName, RGBHistogramDescriptor a)
			throws Exception {
		if (a == null)
			throw new SingularityTreatmentException(methodName
					+ ": first argument null value");
		return true; // if we get here, we've had no exceptions.
	}

	public boolean chkargs(String methodName, GrayscaleHistogramDescriptor a)
			throws Exception {
		if (a == null)
			throw new SingularityTreatmentException(methodName
					+ ": first argument null value");
	...
	public boolean chkargs(String methodName, Double a, Double b)
			throws Exception {
		if (a.equals(Double.NaN))
			throw new HWIndependenceException(methodName
					+ ": first argument NAN indeterminate value");
		if (a.equals(Double.POSITIVE_INFINITY))
			throw new SingularityTreatmentException(methodName
					+ ": first argument POSITIVE_INFINITY value");
		if (a.equals(Double.NEGATIVE_INFINITY))
			throw new SingularityTreatmentException(methodName
					+ ": first argument NEGATIVE_INFINITY value");
		if (b.equals(Double.NaN))
			throw new HWIndependenceException(methodName
					+ ": second argument NAN indeterminate value");
		if (b.equals(Double.POSITIVE_INFINITY))
			throw new SingularityTreatmentException(methodName
					+ ": second argument POSITIVE_INFINITY value");
		if (b.equals(Double.NEGATIVE_INFINITY))
			throw new SingularityTreatmentException(methodName
					+ ": second argument NEGATIVE_INFINITY value");
		if (a == null)
			throw new SingularityTreatmentException(methodName
					+ ": first argument null value");
		if (b == null)
			throw new SingularityTreatmentException(methodName
					+ ": second argument null value");
		return true; // if we get here, we've had no exceptions.
	}
	...
	public boolean chkargs(String methodName, Integer[] a, Integer[] b)
			throws Exception {
		if (a == null)
			throw new SingularityTreatmentException(methodName
					+ ": first argument null value");
	...
	public boolean chkargs(String methodName, ImageData a, ImageData b)
			throws Exception {
		if (a == null)
			throw new SingularityTreatmentException(methodName
					+ ": first argument null value");
	...
	public boolean chkresult(String methodName, ImageData a) throws Exception {
		return chkargs(methodName, a); // if we get here, we've had no
										// exceptions.
	}
	...
	public boolean chkresult(String methodName, Double[][][] a)
			throws Exception {
		return chkargs(methodName, a);
	}
	...
	public boolean chkresult(String methodName, Integer[][][] a)
			throws Exception {
		return chkargs(methodName, a);
	}
	...
	public ImageData array2Img(Double[] A, Integer rows, Integer cols,
			Integer bands) throws Exception {
		chkargs("array2Img", A);
		...
		for (int i = 0; i < len1; i++) {
			for (int j = 0; j < len2; j++) {
				for (int k = 0; k < len3; k++) {
					...
					// System.out.println("(i,j,k,len1,len2,len3,idx)=("+i+","+j+","+k+","+len1+","+len2+","+len3+",B["+i+"]["+j+"]["+k+"]) = A["+idx+"] = "
					// + A[idx] );
					B[i][j][k] = A[idx];
				}
			}
	...
	public Double pixel_measure_ari_nD(Double[] im1, Double[] im2)
			throws Exception {
		...
		for (int i = 0; i < imgSize; i++) {
			im1Idx = im1[i].intValue(); // get pixel index values into the
										...
										// pixelValueCoordinateSpace
			im2Idx = im2[i].intValue();
			commonPixels[im1Idx][im2Idx]++; // increment relative pixel values
											// at (im1Px, im2Px) location
		}
		im1 = null;
		im2 = null;
	...
	/*
	 * Perform equivalent of Gauss's Sum (N*(N-1))/2 for a vector of integer
	 * values.
	 */
	...
	public int gaussSum(Integer N) throws Exception {
		chkargs("gaussSum", N);
		Integer result = (N * (N - 1)) / 2; // BJL: BUGFIX - should be n(n+1)/2
											// for true gaussSum; however, only
											// RI/ARI use this, and the correct
											// computation for RI/ARI is
											// n(n-1)/2. So, despite this
											// misnomer, RI/ARI were being
	...
	public Double gaussSum(Double N) throws Exception {
		chkargs("gaussSum", N);
		Double result = (N * (N - 1)) / 2; // BJL: BUGFIX - should be n(n+1)/2
											// for true gaussSum; however, only
											// RI/ARI use this, and the correct
											// computation for RI/ARI is
											// n(n-1)/2. So, despite this
	...
	public Integer div(Integer a, Integer b) throws Exception {
		...
		if (b == 0)
			throw new SingularityTreatmentException(
					"divide by zero during vector divide operation");
		Integer result = a / b;
	...
	public Double pixel_measure_ri_nD(Double[] im1, Double[] im2)
			throws Exception {
	...
	public Double pixel_measure_dice_nD(Double[] im1, Double[] im2)
			throws Exception {
	...
	public Double pixel_measure_jaccard_nD(Double[] im1, Double[] im2)
			throws Exception {
	 ...
	 */
	public Double[] pvrel_greaterThan(Double[] img, Double pixelValue)
			throws Exception {
	 ...
	 */
	public Double[] pvrel_equalTo(Double[] img, Double pixelValue)
			throws Exception {
	...
	public Double pixel_measure_tee_nD(Double[] im1, Double[] im2)
			throws Exception {
	...
	public Double pixel_measure_tet_nD(Double[] im1, Double[] im2)
			throws Exception {
	...
	public Double and(Double a, Double b) throws Exception {
		chkargs("and", a, b);
		Double c = 0.0d;
		if (a.equals(0.0d) && b.equals(0.0d))
			c = 0.0d;
		else if (a.equals(0.0d) && !b.equals(0.0d))
			c = 0.0d;
		else if (!a.equals(0.0d) && b.equals(0.0d))
			c = 0.0d;
	...
	/*
	 * Given an unordered list of non-zero pixel values in an image, provide a
	 * sorted unique lilst of pixel-values occurring there.
	 * 
	 * example: im_nonZeroEntries = mask(origImg, imgMask);
	...
	/*
	 * Get a list of values (often a vectorized sequance of non-zero entries
	 * from an image matrix) return a binary list and 1-entries where the given
	 * value is found in the list and 0-entries are found everywhere else.
	 */

	public Double[] getMatches(Double[] originalContent, Double value)
			throws Exception {
		...
		for (int i = 0; i < len; i++) {
			k = originalContent[i]; // BJL FIX - missing stmt caused getMatches
									// to not show matches as expected.
			if (k.equals(value))
				// if ( k == value )
	...
	public Double[] getColumn(Double[][] M, Integer rows, Integer col)
			throws Exception {
		chkargs("getColumn", M);
	...
	public Double[] getRow(Double M[][], Integer cols, Integer row)
			throws Exception {
		chkargs("getRow", M);
		chkargs("getRow", cols);
		chkargs("getRow", row);
	...
	public Double[][] makeZeroMatrix2D(Integer rows, Integer cols, Double value)
			throws Exception {
