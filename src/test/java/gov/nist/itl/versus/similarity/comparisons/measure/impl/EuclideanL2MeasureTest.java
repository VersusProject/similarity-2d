...
public class EuclideanL2MeasureTest extends junit.framework.TestCase
{
	...
	// grayscale	
		...
		try {
			...
			String SEP = ",";
			String rString = fileName1 + SEP + fileName2 + SEP + "ImageObjectAdapter" + SEP + "GrayscaleHistogramDescriptor" + SEP + "EuclideanL2Measure" + SEP + result.getValue() ;
	...
	// rgb
		...
		try {
			...
			String SEP = ",";
			String rString = fileName1 + SEP + fileName2 + SEP + "ImageObjectAdapter" + SEP + "RGBHistogramDescriptor" + SEP + "EuclideanL2Measure" + SEP + rresult.getValue() ;
			System.out.println ( rString );
