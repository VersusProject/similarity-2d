 ...
 * Version: 1.0
 *    Date: Fri Dec 23 20:02:49 EST 2011
 */
 ...
 * 
 */
public class CzekanowskiMeasureTest 
{
	@Test
	public void test()
	{
	...
	// grayscale
		...
		try {
			...
			System.out.println( "CzekanowskiMeasure Similarity value (Grayscale)\t" + result.getValue() + "\t" + fileName1 + "\t" + fileName2  );
	...
	// rgb
		...
		try {
			...
			CzekanowskiMeasure rm 		= new CzekanowskiMeasure();
			SimilarityNumber rresult 	= rm.compare(rdesc1, rdesc2);
			System.out.println( "CzekanowskiMeasure Similarity value (RGB)\t" + rresult.getValue() + "\t" + fileName1 + "\t" + fileName2  );
	...
	{
		new CzekanowskiMeasureTest().test();
	}
}
