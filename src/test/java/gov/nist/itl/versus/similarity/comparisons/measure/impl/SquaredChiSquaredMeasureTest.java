...
public class SquaredChiSquaredMeasureTest extends junit.framework.TestCase
{
	...
	// grayscale	
		...
		try {
			...
			String SEP = ",";
			String rString = fileName1 + SEP + fileName2 + SEP + "ImageObjectAdapter" + SEP + "GrayscaleHistogramDescriptor" + SEP + "SquaredChiSquaredMeasure" + SEP + result.getValue() ;
	...
	// rgb
		...
		try {
			...
			SquaredChiSquaredMeasure rm 		= new SquaredChiSquaredMeasure();
			...
			String SEP = ",";
			String rString = fileName1 + SEP + fileName2 + SEP + "ImageObjectAdapter" + SEP + "RGBHistogramDescriptor" + SEP + "SquaredChiSquaredMeasure" + SEP + rresult.getValue() ;
			System.out.println ( rString );
