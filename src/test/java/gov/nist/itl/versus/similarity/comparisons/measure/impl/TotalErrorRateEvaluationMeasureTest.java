...
public class TotalErrorRateEvaluationMeasureTest extends junit.framework.TestCase
{
	...
	// unlabeled case: whole image (no labels)	
		...
		try {
			...
			String SEP = ",";
			String rString = fileName1 + SEP + fileName2 + SEP + "ImageObjectAdapter" + SEP + "ThreeDimensionalDoubleArrayFeature" + SEP + "TotalErrorRateEvaluationMeasure" + SEP + result.getValue() ;
