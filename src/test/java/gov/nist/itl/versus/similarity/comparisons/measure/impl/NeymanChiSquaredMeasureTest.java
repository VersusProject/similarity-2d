 ...
 * 
 */
public class NeymanChiSquaredMeasureTest 
{
	@Test
	public void test()
	{
	...
	// grayscale
		...
		try {
			...
			System.out.println( "NeymanChiSquaredMeasure Similarity value (Grayscale)\t" + result.getValue() + "\t" + fileName1 + "\t" + fileName2  );
	...
	// rgb
		...
		try {
			...
			NeymanChiSquaredMeasure rm 		= new NeymanChiSquaredMeasure();
			SimilarityNumber rresult 	= rm.compare(rdesc1, rdesc2);
			System.out.println( "NeymanChiSquaredMeasure Similarity value (RGB)\t" + rresult.getValue() + "\t" + fileName1 + "\t" + fileName2  );
	...
	{
		new NeymanChiSquaredMeasureTest().test();
	}
}
