...
public class MatusitaDMeasureTest extends junit.framework.TestCase
{
	...
	// grayscale	
		...
		try {
			...
			String SEP = ",";
			String rString = fileName1 + SEP + fileName2 + SEP + "ImageObjectAdapter" + SEP + "GrayscaleHistogramDescriptor" + SEP + "MatusitaDMeasure" + SEP + result.getValue() ;
	...
	// rgb
		...
		try {
			...
			MatusitaDMeasure rm 		= new MatusitaDMeasure();
			...
			String SEP = ",";
			String rString = fileName1 + SEP + fileName2 + SEP + "ImageObjectAdapter" + SEP + "RGBHistogramDescriptor" + SEP + "MatusitaDMeasure" + SEP + rresult.getValue() ;
			System.out.println ( rString );
