 ...
 * Version: 1.0
 *    Date: Fri Dec 23 20:03:01 EST 2011
 */
 ...
 * 
 */
public class DivergenceMeasureTest 
{
	@Test
	public void test()
	{
	...
	// grayscale
		...
		try {
			...
			System.out.println( "DivergenceMeasure Similarity value (Grayscale)\t" + result.getValue() + "\t" + fileName1 + "\t" + fileName2  );
	...
	// rgb
		...
		try {
			...
			DivergenceMeasure rm 		= new DivergenceMeasure();
			SimilarityNumber rresult 	= rm.compare(rdesc1, rdesc2);
			System.out.println( "DivergenceMeasure Similarity value (RGB)\t" + rresult.getValue() + "\t" + fileName1 + "\t" + fileName2  );
	...
	{
		new DivergenceMeasureTest().test();
	}
}
