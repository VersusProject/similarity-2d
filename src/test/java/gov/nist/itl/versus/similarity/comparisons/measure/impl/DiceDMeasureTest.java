...
public class DiceDMeasureTest extends junit.framework.TestCase
{
	...
	// grayscale	
		...
		try {
			...
			String SEP = ",";
			String rString = fileName1 + SEP + fileName2 + SEP + "ImageObjectAdapter" + SEP + "GrayscaleHistogramDescriptor" + SEP + "DiceDMeasure" + SEP + result.getValue() ;
	...
	// rgb
		...
		try {
			...
			DiceDMeasure rm 		= new DiceDMeasure();
			...
			String SEP = ",";
			String rString = fileName1 + SEP + fileName2 + SEP + "ImageObjectAdapter" + SEP + "RGBHistogramDescriptor" + SEP + "DiceDMeasure" + SEP + rresult.getValue() ;
			System.out.println ( rString );
