 ...
 * Version: 1.0
 *    Date: Fri Dec 23 20:03:05 EST 2011
 */
 ...
 * 
 */
public class JensenDifferenceMeasureTest 
{
	@Test
	public void test()
	{
	...
	// grayscale
		...
		try {
			...
			System.out.println( "JensenDifferenceMeasure Similarity value (Grayscale)\t" + result.getValue() + "\t" + fileName1 + "\t" + fileName2  );
	...
	// rgb
		...
		try {
			...
			JensenDifferenceMeasure rm 		= new JensenDifferenceMeasure();
			SimilarityNumber rresult 	= rm.compare(rdesc1, rdesc2);
			System.out.println( "JensenDifferenceMeasure Similarity value (RGB)\t" + rresult.getValue() + "\t" + fileName1 + "\t" + fileName2  );
	...
	{
		new JensenDifferenceMeasureTest().test();
	}
}
