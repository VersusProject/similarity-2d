 ...
 * Version: 1.0
 *    Date: Fri Dec 23 20:02:50 EST 2011
 */
 ...
 * 
 */
public class KulczynskiSMeasureTest 
{
	@Test
	public void test()
	{
	...
	// grayscale
		...
		try {
			...
			System.out.println( "KulczynskiSMeasure Similarity value (Grayscale)\t" + result.getValue() + "\t" + fileName1 + "\t" + fileName2  );
	...
	// rgb
		...
		try {
			...
			KulczynskiSMeasure rm 		= new KulczynskiSMeasure();
			SimilarityNumber rresult 	= rm.compare(rdesc1, rdesc2);
			System.out.println( "KulczynskiSMeasure Similarity value (RGB)\t" + rresult.getValue() + "\t" + fileName1 + "\t" + fileName2  );
	...
	{
		new KulczynskiSMeasureTest().test();
	}
}
