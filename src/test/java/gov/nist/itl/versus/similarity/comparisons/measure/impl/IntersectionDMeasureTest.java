...
public class IntersectionDMeasureTest extends junit.framework.TestCase
{
	...
	// grayscale	
		...
		try {
			...
			String SEP = ",";
			String rString = fileName1 + SEP + fileName2 + SEP + "ImageObjectAdapter" + SEP + "GrayscaleHistogramDescriptor" + SEP + "IntersectionDMeasure" + SEP + result.getValue() ;
	...
	// rgb
		...
		try {
			...
			IntersectionDMeasure rm 		= new IntersectionDMeasure();
			...
			String SEP = ",";
			String rString = fileName1 + SEP + fileName2 + SEP + "ImageObjectAdapter" + SEP + "RGBHistogramDescriptor" + SEP + "IntersectionDMeasure" + SEP + rresult.getValue() ;
			System.out.println ( rString );
