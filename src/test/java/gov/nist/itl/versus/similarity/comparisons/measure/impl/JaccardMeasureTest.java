...
public class JaccardMeasureTest extends junit.framework.TestCase
{
	...
	// grayscale	
		...
		try {
			...
			String SEP = ",";
			String rString = fileName1 + SEP + fileName2 + SEP + "ImageObjectAdapter" + SEP + "GrayscaleHistogramDescriptor" + SEP + "JaccardMeasure" + SEP + result.getValue() ;
	...
	// rgb
		...
		try {
			...
			JaccardMeasure rm 		= new JaccardMeasure();
			...
			String SEP = ",";
			String rString = fileName1 + SEP + fileName2 + SEP + "ImageObjectAdapter" + SEP + "RGBHistogramDescriptor" + SEP + "JaccardMeasure" + SEP + rresult.getValue() ;
			System.out.println ( rString );
