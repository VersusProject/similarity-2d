...
public class JaccardMeasureTest 
{
	...
	// grayscale
		...
		try {
			...
			System.out.println( "JaccardMeasure Similarity value (Grayscale)\t" + result.getValue() + "\t" + fileName1 + "\t" + fileName2  );
	...
	// rgb
		...
		try {
			...
			System.out.println( "JaccardMeasure Similarity value (RGB)\t" + rresult.getValue() + "\t" + fileName1 + "\t" + fileName2  );
