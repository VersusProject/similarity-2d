 ...
 * Version: 1.0
 *    Date: Fri Dec 23 20:03:00 EST 2011
 */
 ...
 * 
 */
public class ProbabilisticSymmetricChiSquaredMeasureTest 
{
	@Test
	public void test()
	{
	...
	// grayscale
		...
		try {
			...
			System.out.println( "ProbabilisticSymmetricChiSquaredMeasure Similarity value (Grayscale)\t" + result.getValue() + "\t" + fileName1 + "\t" + fileName2  );
	...
	// rgb
		...
		try {
			...
			ProbabilisticSymmetricChiSquaredMeasure rm 		= new ProbabilisticSymmetricChiSquaredMeasure();
			SimilarityNumber rresult 	= rm.compare(rdesc1, rdesc2);
			System.out.println( "ProbabilisticSymmetricChiSquaredMeasure Similarity value (RGB)\t" + rresult.getValue() + "\t" + fileName1 + "\t" + fileName2  );
	...
	{
		new ProbabilisticSymmetricChiSquaredMeasureTest().test();
	}
}
