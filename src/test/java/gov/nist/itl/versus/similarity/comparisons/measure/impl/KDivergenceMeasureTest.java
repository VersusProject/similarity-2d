 ...
 * Version: 1.0
 *    Date: Fri Dec 23 20:03:04 EST 2011
 */
 ...
 * 
 */
public class KDivergenceMeasureTest 
{
	@Test
	public void test()
	{
	...
	// grayscale
		...
		try {
			...
			System.out.println( "KDivergenceMeasure Similarity value (Grayscale)\t" + result.getValue() + "\t" + fileName1 + "\t" + fileName2  );
	...
	// rgb
		...
		try {
			...
			KDivergenceMeasure rm 		= new KDivergenceMeasure();
			SimilarityNumber rresult 	= rm.compare(rdesc1, rdesc2);
			System.out.println( "KDivergenceMeasure Similarity value (RGB)\t" + rresult.getValue() + "\t" + fileName1 + "\t" + fileName2  );
	...
	{
		new KDivergenceMeasureTest().test();
	}
}
