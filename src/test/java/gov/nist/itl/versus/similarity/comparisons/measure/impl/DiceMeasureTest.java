...
public class DiceMeasureTest extends junit.framework.TestCase
{
	...
	// grayscale	
		...
		try {
			...
			String SEP = ",";
			String rString = fileName1 + SEP + fileName2 + SEP + "ImageObjectAdapter" + SEP + "GrayscaleHistogramDescriptor" + SEP + "DiceMeasure" + SEP + result.getValue() ;
	...
	// rgb
		...
		try {
			...
			DiceMeasure rm 		= new DiceMeasure();
			...
			String SEP = ",";
			String rString = fileName1 + SEP + fileName2 + SEP + "ImageObjectAdapter" + SEP + "RGBHistogramDescriptor" + SEP + "DiceMeasure" + SEP + rresult.getValue() ;
			System.out.println ( rString );
