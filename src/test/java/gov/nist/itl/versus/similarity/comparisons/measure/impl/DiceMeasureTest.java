...
public class DiceMeasureTest 
{
	...
	// grayscale
		...
		try {
			...
			System.out.println( "DiceMeasure Similarity value (Grayscale)\t" + result.getValue() + "\t" + fileName1 + "\t" + fileName2  );
	...
	// rgb
		...
		try {
			...
			System.out.println( "DiceMeasure Similarity value (RGB)\t" + rresult.getValue() + "\t" + fileName1 + "\t" + fileName2  );
