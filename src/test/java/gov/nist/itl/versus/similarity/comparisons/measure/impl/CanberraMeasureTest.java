 ...
 * 
 */
public class CanberraMeasureTest 
{
	@Test
	public void test()
	{
	...
	// grayscale
		...
		try {
			...
			System.out.println( "CanberraMeasure Similarity value (Grayscale)\t" + result.getValue() + "\t" + fileName1 + "\t" + fileName2  );
	...
	// rgb
		...
		try {
			...
			CanberraMeasure rm 		= new CanberraMeasure();
			SimilarityNumber rresult 	= rm.compare(rdesc1, rdesc2);
			System.out.println( "CanberraMeasure Similarity value (RGB)\t" + rresult.getValue() + "\t" + fileName1 + "\t" + fileName2  );
