 ...
 * Version: 1.0
 *    Date: Fri Dec 23 20:02:56 EST 2011
 */
 ...
 * 
 */
public class BhattacharyyaMeasureTest 
{
	@Test
	public void test()
	{
	...
	// grayscale
		...
		try {
			...
			System.out.println( "BhattacharyyaMeasure Similarity value (Grayscale)\t" + result.getValue() + "\t" + fileName1 + "\t" + fileName2  );
	...
	// rgb
		...
		try {
			...
			BhattacharyyaMeasure rm 		= new BhattacharyyaMeasure();
			SimilarityNumber rresult 	= rm.compare(rdesc1, rdesc2);
			System.out.println( "BhattacharyyaMeasure Similarity value (RGB)\t" + rresult.getValue() + "\t" + fileName1 + "\t" + fileName2  );
	...
	{
		new BhattacharyyaMeasureTest().test();
	}
}
