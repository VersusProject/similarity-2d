 ...
 * Version: 1.0
 *    Date: Fri Dec 23 20:02:47 EST 2011
 */
 ...
 * 
 */
public class LorentzianMeasureTest 
{
	@Test
	public void test()
	{
	...
	// grayscale
		...
		try {
			...
			System.out.println( "LorentzianMeasure Similarity value (Grayscale)\t" + result.getValue() + "\t" + fileName1 + "\t" + fileName2  );
	...
	// rgb
		...
		try {
			...
			LorentzianMeasure rm 		= new LorentzianMeasure();
			SimilarityNumber rresult 	= rm.compare(rdesc1, rdesc2);
			System.out.println( "LorentzianMeasure Similarity value (RGB)\t" + rresult.getValue() + "\t" + fileName1 + "\t" + fileName2  );
	...
	{
		new LorentzianMeasureTest().test();
	}
}
