 ...
 * Version: 1.0
 *    Date: Fri Dec 23 20:02:48 EST 2011
 */
 ...
 * 
 */
public class IntersectionMeasureTest 
{
	@Test
	public void test()
	{
	...
	// grayscale
		...
		try {
			...
			System.out.println( "IntersectionMeasure Similarity value (Grayscale)\t" + result.getValue() + "\t" + fileName1 + "\t" + fileName2  );
	...
	// rgb
		...
		try {
			...
			IntersectionMeasure rm 		= new IntersectionMeasure();
			SimilarityNumber rresult 	= rm.compare(rdesc1, rdesc2);
			System.out.println( "IntersectionMeasure Similarity value (RGB)\t" + rresult.getValue() + "\t" + fileName1 + "\t" + fileName2  );
	...
	{
		new IntersectionMeasureTest().test();
	}
}
