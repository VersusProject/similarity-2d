...
public class JaccardPixelMeasureTest extends junit.framework.TestCase
{
	...
	public JaccardPixelMeasureTest(){
	...
	// unlabeled case: whole image (no labels)	
		...
		try {
			...
			JaccardPixelMeasure m 		= new JaccardPixelMeasure();
				if ( m == null )
					throw new SWIndependenceException("failed to create JaccardPixelMeasure object for measure");				
			...
			String SEP = ",";
			String rString = fileName1 + SEP + fileName2 + SEP + "ImageObjectAdapter" + SEP + "ThreeDimensionalDoubleArrayFeature" + SEP + "JaccardPixelMeasure" + SEP + result.getValue() ;
	...
	public static SimilarityNumber[] labeled( String fileName1, String fileName2 ) throws Exception
	{
		...
		try {
			...
			JaccardPixelMeasure lm 		= new JaccardPixelMeasure();			
				if ( lm == null )
					throw new SWIndependenceException("failed to create JaccardPixelMeasure object for measure");	
...
////////////////	
	...
	{
		org.junit.runner.JUnitCore.runClasses( JaccardPixelMeasureTest.class );
	}
}