 ...
 * Version: 1.0
 *    Date: Fri Dec 23 20:02:58 EST 2011
 */
 ...
 * 
 */
public class SquaredEuclideanMeasureTest 
{
	@Test
	public void test()
	{
	...
	// grayscale
		...
		try {
			...
			System.out.println( "SquaredEuclideanMeasure Similarity value (Grayscale)\t" + result.getValue() + "\t" + fileName1 + "\t" + fileName2  );
	...
	// rgb
		...
		try {
			...
			SquaredEuclideanMeasure rm 		= new SquaredEuclideanMeasure();
			SimilarityNumber rresult 	= rm.compare(rdesc1, rdesc2);
			System.out.println( "SquaredEuclideanMeasure Similarity value (RGB)\t" + rresult.getValue() + "\t" + fileName1 + "\t" + fileName2  );
	...
	{
		new SquaredEuclideanMeasureTest().test();
	}
}
