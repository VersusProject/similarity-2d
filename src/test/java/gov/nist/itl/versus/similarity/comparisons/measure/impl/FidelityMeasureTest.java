 ...
 * Version: 1.0
 *    Date: Fri Dec 23 20:02:55 EST 2011
 */
 ...
 * 
 */
public class FidelityMeasureTest 
{
	@Test
	public void test()
	{
	...
	// grayscale
		...
		try {
			...
			System.out.println( "FidelityMeasure Similarity value (Grayscale)\t" + result.getValue() + "\t" + fileName1 + "\t" + fileName2  );
	...
	// rgb
		...
		try {
			...
			FidelityMeasure rm 		= new FidelityMeasure();
			SimilarityNumber rresult 	= rm.compare(rdesc1, rdesc2);
			System.out.println( "FidelityMeasure Similarity value (RGB)\t" + rresult.getValue() + "\t" + fileName1 + "\t" + fileName2  );
