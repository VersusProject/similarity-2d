...
public class ClarkMeasureTest 
{
	...
	// grayscale
		...
		try {
			...
			System.out.println( "ClarkMeasure Similarity value (Grayscale)\t" + result.getValue() + "\t" + fileName1 + "\t" + fileName2  );
	...
	// rgb
		...
		try {
			...
			ClarkMeasure rm 		= new ClarkMeasure();
			SimilarityNumber rresult 	= rm.compare(rdesc1, rdesc2);
			System.out.println( "ClarkMeasure Similarity value (RGB)\t" + rresult.getValue() + "\t" + fileName1 + "\t" + fileName2  );
