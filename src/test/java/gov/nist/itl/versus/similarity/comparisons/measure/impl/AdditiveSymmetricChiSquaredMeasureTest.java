 ...
 * Version: 1.0
 *    Date: Fri Dec 23 20:03:02 EST 2011
 */
 ...
 * 
 */
public class AdditiveSymmetricChiSquaredMeasureTest 
{
	@Test
	public void test()
	{
	...
	// grayscale
		...
		try {
			...
			System.out.println( "AdditiveSymmetricChiSquaredMeasure Similarity value (Grayscale)\t" + result.getValue() + "\t" + fileName1 + "\t" + fileName2  );
	...
	// rgb
		...
		try {
			...
			AdditiveSymmetricChiSquaredMeasure rm 		= new AdditiveSymmetricChiSquaredMeasure();
			SimilarityNumber rresult 	= rm.compare(rdesc1, rdesc2);
			System.out.println( "AdditiveSymmetricChiSquaredMeasure Similarity value (RGB)\t" + rresult.getValue() + "\t" + fileName1 + "\t" + fileName2  );
	...
	{
		new AdditiveSymmetricChiSquaredMeasureTest().test();
	}
}
