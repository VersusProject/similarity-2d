 ...
 * Version: 1.0
 *    Date: Fri Dec 23 20:03:06 EST 2011
 */
 ...
 * 
 */
public class TanejaDifferenceMeasureTest 
{
	@Test
	public void test()
	{
	...
	// grayscale
		...
		try {
			...
			System.out.println( "TanejaDifferenceMeasure Similarity value (Grayscale)\t" + result.getValue() + "\t" + fileName1 + "\t" + fileName2  );
	...
	// rgb
		...
		try {
			...
			TanejaDifferenceMeasure rm 		= new TanejaDifferenceMeasure();
			SimilarityNumber rresult 	= rm.compare(rdesc1, rdesc2);
			System.out.println( "TanejaDifferenceMeasure Similarity value (RGB)\t" + rresult.getValue() + "\t" + fileName1 + "\t" + fileName2  );
	...
	{
		new TanejaDifferenceMeasureTest().test();
	}
}
