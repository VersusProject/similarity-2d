 ...
 * Version: 1.0
 *    Date: Fri Dec 23 20:02:59 EST 2011
 */
 ...
 * 
 */
public class PearsonChiSquaredMeasureTest 
{
	@Test
	public void test()
	{
	...
	// grayscale
		...
		try {
			...
			System.out.println( "PearsonChiSquaredMeasure Similarity value (Grayscale)\t" + result.getValue() + "\t" + fileName1 + "\t" + fileName2  );
	...
	// rgb
		...
		try {
			...
			PearsonChiSquaredMeasure rm 		= new PearsonChiSquaredMeasure();
			SimilarityNumber rresult 	= rm.compare(rdesc1, rdesc2);
			System.out.println( "PearsonChiSquaredMeasure Similarity value (RGB)\t" + rresult.getValue() + "\t" + fileName1 + "\t" + fileName2  );
	...
	{
		new PearsonChiSquaredMeasureTest().test();
	}
}
