...
public class CosineMeasureTest extends junit.framework.TestCase
{
	...
	// grayscale	
		...
		try {
			...
			String SEP = ",";
			String rString = fileName1 + SEP + fileName2 + SEP + "ImageObjectAdapter" + SEP + "GrayscaleHistogramDescriptor" + SEP + "CosineMeasure" + SEP + result.getValue() ;
	...
	// rgb
		...
		try {
			...
			CosineMeasure rm 		= new CosineMeasure();
			...
			String SEP = ",";
			String rString = fileName1 + SEP + fileName2 + SEP + "ImageObjectAdapter" + SEP + "RGBHistogramDescriptor" + SEP + "CosineMeasure" + SEP + rresult.getValue() ;
			System.out.println ( rString );
