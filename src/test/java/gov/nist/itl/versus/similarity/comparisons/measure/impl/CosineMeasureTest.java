 ...
 * Version: 1.0
 *    Date: Fri Dec 23 20:02:53 EST 2011
 */
...
public class CosineMeasureTest 
{
	...
	// grayscale
		...
		try {
			...
			System.out.println( "CosineMeasure Similarity value (Grayscale)\t" + result.getValue() + "\t" + fileName1 + "\t" + fileName2  );
	...
	// rgb
		...
		try {
			...
			System.out.println( "CosineMeasure Similarity value (RGB)\t" + rresult.getValue() + "\t" + fileName1 + "\t" + fileName2  );
