 ...
 * Version: 1.0
 *    Date: Fri Dec 23 20:03:07 EST 2011
 */
 ...
 * 
 */
public class KumarJohnsonDifferenceMeasureTest 
{
	@Test
	public void test()
	{
	...
	// grayscale
		...
		try {
			...
			System.out.println( "KumarJohnsonDifferenceMeasure Similarity value (Grayscale)\t" + result.getValue() + "\t" + fileName1 + "\t" + fileName2  );
	...
	// rgb
		...
		try {
			...
			KumarJohnsonDifferenceMeasure rm 		= new KumarJohnsonDifferenceMeasure();
			SimilarityNumber rresult 	= rm.compare(rdesc1, rdesc2);
			System.out.println( "KumarJohnsonDifferenceMeasure Similarity value (RGB)\t" + rresult.getValue() + "\t" + fileName1 + "\t" + fileName2  );
	...
	{
		new KumarJohnsonDifferenceMeasureTest().test();
	}
}
