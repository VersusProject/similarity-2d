...
public class MinkowskiMeasureTest extends junit.framework.TestCase
{
	...
	// grayscale	
		...
		try {
			...
			String SEP = ",";
			String rString = fileName1 + SEP + fileName2 + SEP + "ImageObjectAdapter" + SEP + "GrayscaleHistogramDescriptor" + SEP + "MinkowskiMeasure" + SEP + result.getValue() ;
	...
	// rgb
		...
		try {
			...
			MinkowskiMeasure rm 		= new MinkowskiMeasure();
			...
			String SEP = ",";
			String rString = fileName1 + SEP + fileName2 + SEP + "ImageObjectAdapter" + SEP + "RGBHistogramDescriptor" + SEP + "MinkowskiMeasure" + SEP + rresult.getValue() ;
			System.out.println ( rString );
