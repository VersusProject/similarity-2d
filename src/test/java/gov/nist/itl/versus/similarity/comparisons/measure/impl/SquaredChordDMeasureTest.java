...
public class SquaredChordDMeasureTest extends junit.framework.TestCase
{
	...
	// grayscale	
		...
		try {
			...
			String SEP = ",";
			String rString = fileName1 + SEP + fileName2 + SEP + "ImageObjectAdapter" + SEP + "GrayscaleHistogramDescriptor" + SEP + "SquaredChordDMeasure" + SEP + result.getValue() ;
	...
	// rgb
		...
		try {
			...
			SquaredChordDMeasure rm 		= new SquaredChordDMeasure();
			...
			String SEP = ",";
			String rString = fileName1 + SEP + fileName2 + SEP + "ImageObjectAdapter" + SEP + "RGBHistogramDescriptor" + SEP + "SquaredChordDMeasure" + SEP + rresult.getValue() ;
			System.out.println ( rString );
