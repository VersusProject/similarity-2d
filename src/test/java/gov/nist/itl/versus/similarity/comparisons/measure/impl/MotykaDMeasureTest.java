...
public class MotykaDMeasureTest extends junit.framework.TestCase
{
	...
	// grayscale	
		...
		try {
			...
			String SEP = ",";
			String rString = fileName1 + SEP + fileName2 + SEP + "ImageObjectAdapter" + SEP + "GrayscaleHistogramDescriptor" + SEP + "MotykaDMeasure" + SEP + result.getValue() ;
	...
	// rgb
		...
		try {
			...
			MotykaDMeasure rm 		= new MotykaDMeasure();
			...
			String SEP = ",";
			String rString = fileName1 + SEP + fileName2 + SEP + "ImageObjectAdapter" + SEP + "RGBHistogramDescriptor" + SEP + "MotykaDMeasure" + SEP + rresult.getValue() ;
			System.out.println ( rString );
