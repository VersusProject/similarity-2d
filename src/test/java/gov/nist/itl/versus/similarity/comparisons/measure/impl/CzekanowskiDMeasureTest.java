...
public class CzekanowskiDMeasureTest extends junit.framework.TestCase
{
	...
	// grayscale	
		...
		try {
			...
			String SEP = ",";
			String rString = fileName1 + SEP + fileName2 + SEP + "ImageObjectAdapter" + SEP + "GrayscaleHistogramDescriptor" + SEP + "CzekanowskiDMeasure" + SEP + result.getValue() ;
	...
	// rgb
		...
		try {
			...
			CzekanowskiDMeasure rm 		= new CzekanowskiDMeasure();
			...
			String SEP = ",";
			String rString = fileName1 + SEP + fileName2 + SEP + "ImageObjectAdapter" + SEP + "RGBHistogramDescriptor" + SEP + "CzekanowskiDMeasure" + SEP + rresult.getValue() ;
			System.out.println ( rString );
