 ...
 * Version: 1.0
 *    Date: Fri Dec 23 20:02:54 EST 2011
 */
 ...
 * 
 */
public class KumarHassebrookPCEMeasureTest 
{
	@Test
	public void test()
	{
	...
	// grayscale
		...
		try {
			...
			System.out.println( "KumarHassebrookPCEMeasure Similarity value (Grayscale)\t" + result.getValue() + "\t" + fileName1 + "\t" + fileName2  );
	...
	// rgb
		...
		try {
			...
			KumarHassebrookPCEMeasure rm 		= new KumarHassebrookPCEMeasure();
			SimilarityNumber rresult 	= rm.compare(rdesc1, rdesc2);
			System.out.println( "KumarHassebrookPCEMeasure Similarity value (RGB)\t" + rresult.getValue() + "\t" + fileName1 + "\t" + fileName2  );
	...
	{
		new KumarHassebrookPCEMeasureTest().test();
	}
}
