...
public class JaccardDMeasureTest extends junit.framework.TestCase
{
	...
	// grayscale	
		...
		try {
			...
			String SEP = ",";
			String rString = fileName1 + SEP + fileName2 + SEP + "ImageObjectAdapter" + SEP + "GrayscaleHistogramDescriptor" + SEP + "JaccardDMeasure" + SEP + result.getValue() ;
	...
	// rgb
		...
		try {
			...
			JaccardDMeasure rm 		= new JaccardDMeasure();
			...
			String SEP = ",";
			String rString = fileName1 + SEP + fileName2 + SEP + "ImageObjectAdapter" + SEP + "RGBHistogramDescriptor" + SEP + "JaccardDMeasure" + SEP + rresult.getValue() ;
			System.out.println ( rString );
